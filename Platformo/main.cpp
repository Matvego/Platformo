...
int change_gamelevel(Platforma platforma[], int gamelevel)
{
    ...
    else if (gamelevel == 7)
    {
        ...
        platforma[2] = {570,250,400,200,txLoadImage("PlatformaDvig.bmp"), 1,0,0, platforma[2].y,platforma[2].y, 200, 100};
    ...
    else if (gamelevel == 8)
    {
        count_platform = 3 ;
        platforma[0] = {-50,550,400,200,txLoadImage("Platforma.bmp"), 0,0,0, platforma[0].y,platforma[0].y,200,100};
        platforma[1] = {570,350,400,200,txLoadImage("PlatformaDvig.bmp"), 1,0,0, platforma[2].y,platforma[2].y, 200, 100};
        platforma[2] = {1250,550,400,200,txLoadImage("Platforma.bmp"), 0,0,0, platforma[4].y,platforma[4].y,200,100};
...
char str[50];
   ...
   while(!GetAsyncKeyState(VK_ESCAPE))
   {
      ...
      if (gamelevel == 8)
      {
        ...
        txTextOut(450, 100, "Ты прошёл игру,молодец!");
      }
      if (gamelevel == 9)
      {
        txSelectFont ("Comic Sans MS", 50);
        txTextOut(420, 100, "Не иди дальше,там ничего нет");
      }
      ...
      if (gamelevel == 1)
      {
        ...
        txTextOut(20,20, "Управление");
        txTextOut(20,50, "Ходить:Стрелочки");
        txTextOut(20,80, "Прыгать:Пробел");
        txTextOut(20,110, "Двигать платформы:WASD");
      }
      ...
      for(int i=0; i<count_platform; i++)
      {
       ...
       if (player1.x == vrag1.x && player1.y == vrag1.y && gamelevel == 7)
       {
          player1.x = 0;
          player1.y = 0;
       }*/
